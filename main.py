...
class MainEngine(object):
    ...
    def __initWidgets(self):
        ...
        self.wLvLabel = Label(self.root, text="Select Lvl from 1 to 10",width=25,fg='red',bg='thistle',font=("Comic Sans MS",15,"bold"),borderwidth=10, relief="groove")
        self.wLvEntry = Entry(self.root,borderwidth=10,width="35")
        self.wLvBtn = Button(self.root, text="Click here to start", command=self.lvSelect,font=("Comic Sans MS",10,"bold"), width=15, height=1,bg="thistle",fg="black",borderwidth=10)
        self.DD = Label(self.root, text="")
        self.DD1 = Label(self.root, text="")
        self.DD2 = Label(self.root, text="")
        self.DD3 = Label(self.root, text="")
        self.DD4 = Label(self.root, text=" DD Pac-Man ",font=("Comic Sans MS",25,"bold"),bg="coral",borderwidth=2, relief="groove")
